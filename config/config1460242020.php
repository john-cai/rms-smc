 ...
 */
$conf['settings']['app.title'] = 'Sky Mountain Camp RMS';			// application title
...
$conf['settings']['admin.email'] = 'johncai86@gmail.com';         // email address of admin user
$conf['settings']['admin.email.name'] = 'John Cai';	// name to be used in From: field when sending automatic emails
...
$conf['settings']['script.url'] = 'https://rms-smc.gracepointonline.org/Web';   	// public URL to the Web directory of this instance. this is the URL that appears when you are logging in. leave http: or https: off to auto-detect
...
$conf['settings']['database']['user'] = 'rms-smc';        // database user with permission to the booked database
...
$conf['settings']['phpmailer']['smtp.host'] = 'smtp.sendgrid.net';               // 'smtp.company.com'
...
$conf['settings']['phpmailer']['smtp.username'] = 'amNhaQ==';
$conf['settings']['phpmailer']['smtp.password'] = 'YnNodjltdUVab01LSmNGa3dRUEVuZE55YmhRaG5GVTI/enM=';
